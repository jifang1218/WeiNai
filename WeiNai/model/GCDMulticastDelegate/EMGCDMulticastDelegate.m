...
@interface EMGCDMulticastDelegate ()
{
...
@interface EMGCDMulticastDelegateEnumerator ()
{
	NSUInteger numNodes;
...
@implementation EMGCDMulticastDelegate
...
- (void)addDelegate:(id)delegate delegateQueue:(dispatch_queue_t)delegateQueue
{
	...
	@synchronized(delegateNodes){
        EMGCDMulticastDelegateNode *node =
	    [[EMGCDMulticastDelegateNode alloc] initWithDelegate:delegate delegateQueue:delegateQueue];
...
- (void)removeDelegate:(id)delegate delegateQueue:(dispatch_queue_t)delegateQueue
{
    ...
    @synchronized(delegateNodes){
        ...
        {
            EMGCDMulticastDelegateNode *node = [delegateNodes objectAtIndex:(i-1)];
...
{
    @synchronized(delegateNodes){
        for (EMGCDMulticastDelegateNode *node in delegateNodes)
        {
            node.delegate = nil;
            #if __has_feature(objc_arc_weak) && !TARGET_OS_IPHONE
            node.unsafeDelegate = nil;
...
- (EMGCDMulticastDelegateEnumerator *)delegateEnumerator
{
	return [[EMGCDMulticastDelegateEnumerator alloc] initFromDelegateNodes:delegateNodes];
}
...
@implementation EMGCDMulticastDelegateNode
...
@implementation EMGCDMulticastDelegateEnumerator
...
- (BOOL)getNextDelegate:(id *)delPtr delegateQueue:(dispatch_queue_t *)dqPtr
{
	...
	{
		EMGCDMulticastDelegateNode *node = [delegateNodes objectAtIndex:currentNodeIndex];
		currentNodeIndex++;
