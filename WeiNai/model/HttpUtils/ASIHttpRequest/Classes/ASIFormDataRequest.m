...
// Private stuff
@interface EMASIFormDataRequest ()
...
@implementation EMASIFormDataRequest
...
- (void)addFile:(NSString *)filePath withFileName:(NSString *)fileName andContentType:(NSString *)contentType forKey:(NSString *)key
{
	...
	if (!fileExists || isDirectory) {
		[self failWithError:[NSError errorWithDomain:EMNetworkRequestErrorDomain code:EMASIInternalErrorWhileBuildingRequestType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"No file exists at %@",filePath],NSLocalizedDescriptionKey,nil]]];
	}
	...
	if (!contentType) {
		contentType = [EMASIHTTPRequest mimeTypeForFileAtPath:filePath];
	}
...
{
	EMASIFormDataRequest *newRequest = [super copyWithZone:zone];
