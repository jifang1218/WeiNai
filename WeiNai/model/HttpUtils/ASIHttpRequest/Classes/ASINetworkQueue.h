...
typedef void (^ASIQueueProgressBlock)(unsigned long long size, unsigned long long total);
...
@property (copy, nonatomic) ASIQueueProgressBlock downloadProgressBlock;
