//
//  EMASICloudFilesObjectRequest.m
//
...
@implementation EMASICloudFilesObjectRequest
...
+ (id)storageRequestWithMethod:(NSString *)method containerName:(NSString *)containerName {
	NSString *urlString = [NSString stringWithFormat:@"%@/%@", [EMASICloudFilesRequest storageURL], containerName];
	EMASICloudFilesObjectRequest *request = [[[EMASICloudFilesObjectRequest alloc] initWithURL:[NSURL URLWithString:urlString]] autorelease];
...
+ (id)storageRequestWithMethod:(NSString *)method containerName:(NSString *)containerName queryString:(NSString *)queryString {
	NSString *urlString = [NSString stringWithFormat:@"%@/%@%@", [EMASICloudFilesRequest storageURL], containerName, queryString];
	EMASICloudFilesObjectRequest *request = [[[EMASICloudFilesObjectRequest alloc] initWithURL:[NSURL URLWithString:urlString]] autorelease];
	[request setRequestMethod:method];
	[request addRequestHeader:@"X-Auth-Token" value:[EMASICloudFilesRequest authToken]];
	request.containerName = containerName;
...
+ (id)storageRequestWithMethod:(NSString *)method containerName:(NSString *)containerName objectPath:(NSString *)objectPath {
	NSString *urlString = [NSString stringWithFormat:@"%@/%@/%@", [EMASICloudFilesRequest storageURL], containerName, objectPath];
	EMASICloudFilesObjectRequest *request = [[[EMASICloudFilesObjectRequest alloc] initWithURL:[NSURL URLWithString:urlString]] autorelease];
	[request setRequestMethod:method];
	[request addRequestHeader:@"X-Auth-Token" value:[EMASICloudFilesRequest authToken]];
	request.containerName = containerName;
...
+ (id)containerInfoRequest:(NSString *)containerName {
	EMASICloudFilesObjectRequest *request = [EMASICloudFilesObjectRequest storageRequestWithMethod:@"HEAD" containerName:containerName];
	return request;
}
...
+ (id)objectInfoRequest:(NSString *)containerName objectPath:(NSString *)objectPath {
	EMASICloudFilesObjectRequest *request = [EMASICloudFilesObjectRequest storageRequestWithMethod:@"HEAD" containerName:containerName objectPath:objectPath];
	return request;
}
...
+ (id)listRequestWithContainer:(NSString *)containerName limit:(NSUInteger)limit marker:(NSString *)marker prefix:(NSString *)prefix path:(NSString *)path {
	NSString *queryString = [EMASICloudFilesObjectRequest queryStringWithContainer:containerName limit:limit marker:marker prefix:prefix path:path];
	EMASICloudFilesObjectRequest *request = [EMASICloudFilesObjectRequest storageRequestWithMethod:@"GET" containerName:containerName queryString:queryString];
	return request;
}

+ (id)listRequestWithContainer:(NSString *)containerName {
	return [EMASICloudFilesObjectRequest listRequestWithContainer:containerName limit:0 marker:nil prefix:nil path:nil];
}
...
+ (id)getObjectRequestWithContainer:(NSString *)containerName objectPath:(NSString *)objectPath {
	return [EMASICloudFilesObjectRequest storageRequestWithMethod:@"GET" containerName:containerName objectPath:objectPath];
}

- (EMASICloudFilesObject *)object {
	EMASICloudFilesObject *object = [EMASICloudFilesObject object];
...
+ (id)putObjectRequestWithContainer:(NSString *)containerName object:(EMASICloudFilesObject *)object {
...
+ (id)putObjectRequestWithContainer:(NSString *)containerName objectPath:(NSString *)objectPath contentType:(NSString *)contentType objectData:(NSData *)objectData metadata:(NSDictionary *)metadata etag:(NSString *)etag {
	...
	EMASICloudFilesObjectRequest *request = [EMASICloudFilesObjectRequest storageRequestWithMethod:@"PUT" containerName:containerName objectPath:objectPath];
...
+ (id)postObjectRequestWithContainer:(NSString *)containerName object:(EMASICloudFilesObject *)object {
...
+ (id)postObjectRequestWithContainer:(NSString *)containerName objectPath:(NSString *)objectPath metadata:(NSDictionary *)metadata {
	EMASICloudFilesObjectRequest *request = [EMASICloudFilesObjectRequest storageRequestWithMethod:@"POST" containerName:containerName objectPath:objectPath];
...
+ (id)deleteObjectRequestWithContainer:(NSString *)containerName objectPath:(NSString *)objectPath {
	EMASICloudFilesObjectRequest *request = [EMASICloudFilesObjectRequest storageRequestWithMethod:@"DELETE" containerName:containerName objectPath:objectPath];
	return request;
}
...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary *)attributeDict {
	...
	if ([elementName isEqualToString:@"object"]) {
		[self setCurrentObject:[EMASICloudFilesObject object]];
	}
