...
@implementation EMASICloudFilesRequest

+ (void)initialize
{
	if (self == [EMASICloudFilesRequest class]) {
...
+ (id)authenticationRequest
{
	...
	EMASIHTTPRequest *request = [[[EMASIHTTPRequest alloc] initWithURL:[NSURL URLWithString:rackspaceCloudAuthURL]] autorelease];
...
{
	[accessDetailsLock lock];
	EMASIHTTPRequest *request = [EMASICloudFilesRequest authenticationRequest];
