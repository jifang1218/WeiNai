...
-(void)cancelNumberPad
{
    ...
    textField.text = @"";
    [self.numberPadDelegate doneCancelNumberPadToolbarDelegate:self didClickCancel:textField];
}

-(void)doneWithNumberPad
{
    [textField resignFirstResponder];
    [self.numberPadDelegate doneCancelNumberPadToolbarDelegate:self didClickDone:textField];
}
@end