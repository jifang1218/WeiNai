...
- (BOOL) isSameWeekOfMonthAsDate: (NSDate *) aDate
{
	NSDateComponents *components1 = [CURRENT_CALENDAR components:DATE_COMPONENTS fromDate:self];
	NSDateComponents *components2 = [CURRENT_CALENDAR components:DATE_COMPONENTS fromDate:aDate];
...
- (BOOL) isThisWeekOfMonth
{
	return [self isSameWeekOfMonthAsDate:[NSDate date]];
}

- (BOOL) isThisWeekOfYear
{
    return [self isSameWeekOfYearAsDate:[NSDate date]];
}

- (BOOL) isNextWeekOfMonth
{
	NSTimeInterval aTimeInterval = [[NSDate date] timeIntervalSinceReferenceDate] + D_WEEK;
	NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
	return [self isSameWeekOfMonthAsDate:newDate];
}

- (BOOL) isNextWeekOfYear
{
    NSTimeInterval aTimeInterval = [[NSDate date] timeIntervalSinceReferenceDate] + D_WEEK;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
